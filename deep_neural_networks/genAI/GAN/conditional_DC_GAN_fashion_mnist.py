...
"""
In this script, I have implemented a conditional DC GAN on fashionMNIST dataset.  Conditional DC GAN stands for
...
image_labels = train_dataset.classes # Get the image labels like Dress, Sandal, Shirt, etc
...
saveImagesFolder = 'conditional_DC_GAN_generated_images_fashionmnist'
...
z_dim = 100
num_class_labels = 10 # For fashion MNIST dataset
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        if ((epoch+1)%5 == 0): # ((epoch+1)%10 == 0):
            ...
            class_labels_str = [f' {image_labels[i]}' for i in class_labels_gen]
    ...
    torch.save(gen.state_dict(),"generator_fashionmnist.pth") # For generation/Inference, only Generator is required!
