...
"""
Implement VAE on Fashion MNIST dataset

In this code, I have implemented a Variational Auto Encoder (VAE) on the fashion MNSIT dataset. I have followed the
video lectures by Pratosh for the VAE implementation.


For the VAE network architecture on Fashion MNIST dataset, I have used the one from the original paper on VAE by
...
saveImagesFolder = 'VAE_fashionMNIST_generated_images'
