...
# mlffnn.set_model_params(mode = 'online',costfn = 'categorical_cross_entropy',epochs=1000)
# trainData = X_data
...
mlffnn = MLFFNeuralNetwork(networkArchitecture)
mlffnn.set_model_params(mode = 'online',costfn = 'squared_error',epochs=100000)
trainData = X_data
trainDataLabels = Y_data
mlffnn.train_nn(trainData,trainDataLabels,stepsize=0.1)
mlffnn.predict_nn(trainData,trainDataLabels)
